...
namespace CSBR.SPD.Order.Repository.Entities
{
    /// <summary>
    /// 公司组织资料实体.
    /// </summary>
    ...
    public class Corporation
    {
        ...
        /// 所属租户Guid.
        /// </summary>
        [Column("TenantGuid", IsNullable = true)]
        ...
        /// 名称.
        /// </summary>
        [Column("ChineseName", IsNullable = true)]
        ...
        /// 助记码.
        /// </summary>
        [Column("HelpCode", IsNullable = true)]
        ...
        /// 英文名称.
        /// </summary>
        [Column("EnglishName", IsNullable = true)]
        ...
        /// 简称.
        /// </summary>
        [Column("Abbreviation", IsNullable = true)]
        ...
        /// 上级公司Guid.
        /// </summary>
        [Column("SuperiorCorpGuid", IsNullable = true)]
        ...
        /// 省份.
        /// </summary>
        [Column("Province", IsNullable = true)]
        ...
        /// 区/县/乡.
        /// </summary>
        [Column("District", IsNullable = true)]
        ...
        /// 地址.
        /// </summary>
        [Column("Address", IsNullable = true)]
        ...
        /// 注册日期.
        /// </summary>
        [Column("RegisteredDate", IsNullable = true)]
        ...
        /// 注册资本(万).
        /// </summary>
        [Column("RegisteredCapital", IsNullable = true)]
        ...
        /// 法人代表.
        /// </summary>
        [Column("PersonInCharge", IsNullable = true)]
        ...
        /// 是否具有第三方资质(Y 是；N 否).
        /// </summary>
        [Column("TplFlag", IsNullable = true)]
        ...
        /// 经营范围.
        /// </summary>
        [Column("OORange", IsNullable = true)]
        ...
        /// 公司电话.
        /// </summary>
        [Column("OrganizationTel", IsNullable = true)]
        ...
        /// 联系人.
        /// </summary>
        [Column("Contacts", IsNullable = true)]
        ...
        /// 联系电话.
        /// </summary>
        [Column("ContactTel", IsNullable = true)]
        ...
        /// 是否发送短信提醒.
        /// </summary>
        [Column("SentMsgFlag", IsNullable = true)]
        ...
        /// 公司传真.
        /// </summary>
        [Column("OrganizationFax", IsNullable = true)]
        ...
        /// 通信地址.
        /// </summary>
        [Column("Mailaddr", IsNullable = true)]
        ...
        /// 收款单位.
        /// </summary>
        [Column("EnterpriseName", IsNullable = true)]
        ...
        /// 收款帐号.
        /// </summary>
        [Column("BankAccount", IsNullable = true)]
        ...
        /// 是否三证合一(Y 是；N 否).
        /// </summary>
        [Column("IsLicThreeToOne", IsNullable = true)]
        ...
        /// 企业图标.
        /// </summary>
        [Column("PictContent", IsNullable = true)]
        ...
        /// 税务名称.
        /// </summary>
        [Column("TaxName", IsNullable = true)]
        ...
        /// 创建时间.
        /// </summary>
        [Column("CreateDateTime", IsNullable = true)]
        ...
        /// 更新时间.
        /// </summary>
        [Column("UpdateDateTime", IsNullable = true)]
