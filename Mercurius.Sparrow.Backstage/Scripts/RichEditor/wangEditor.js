...
_e(function (E, $) {
    ...
    E.config.emotions = {
        'default': {
            ...
            size: 18,
            imgs: [
                '/Scripts/RichEditor/emotions/default/1.gif',
                '/Scripts/RichEditor/emotions/default/2.gif',
                '/Scripts/RichEditor/emotions/default/3.gif',
                '/Scripts/RichEditor/emotions/default/4.gif',
                '/Scripts/RichEditor/emotions/default/5.gif',
                '/Scripts/RichEditor/emotions/default/6.gif',
                '/Scripts/RichEditor/emotions/default/7.gif',
                '/Scripts/RichEditor/emotions/default/8.gif',
                '/Scripts/RichEditor/emotions/default/9.gif',
                '/Scripts/RichEditor/emotions/default/10.gif',
                '/Scripts/RichEditor/emotions/default/11.gif',
                '/Scripts/RichEditor/emotions/default/12.gif',
                '/Scripts/RichEditor/emotions/default/13.gif',
                '/Scripts/RichEditor/emotions/default/14.gif',
                '/Scripts/RichEditor/emotions/default/15.gif',
                '/Scripts/RichEditor/emotions/default/16.gif',
                '/Scripts/RichEditor/emotions/default/17.gif',
                '/Scripts/RichEditor/emotions/default/18.gif',
                '/Scripts/RichEditor/emotions/default/19.gif',
                '/Scripts/RichEditor/emotions/default/20.gif',
                '/Scripts/RichEditor/emotions/default/21.gif',
                '/Scripts/RichEditor/emotions/default/22.gif',
                '/Scripts/RichEditor/emotions/default/23.gif',
                '/Scripts/RichEditor/emotions/default/24.gif',
                '/Scripts/RichEditor/emotions/default/25.gif',
                '/Scripts/RichEditor/emotions/default/26.gif',
                '/Scripts/RichEditor/emotions/default/27.gif',
                '/Scripts/RichEditor/emotions/default/28.gif',
                '/Scripts/RichEditor/emotions/default/29.gif',
                '/Scripts/RichEditor/emotions/default/30.gif',
                '/Scripts/RichEditor/emotions/default/31.gif',
                '/Scripts/RichEditor/emotions/default/32.gif',
                '/Scripts/RichEditor/emotions/default/33.gif',
                '/Scripts/RichEditor/emotions/default/34.gif',
                '/Scripts/RichEditor/emotions/default/35.gif',
                '/Scripts/RichEditor/emotions/default/36.gif',
                '/Scripts/RichEditor/emotions/default/37.gif',
                '/Scripts/RichEditor/emotions/default/38.gif',
                '/Scripts/RichEditor/emotions/default/39.gif',
                '/Scripts/RichEditor/emotions/default/40.gif',
                '/Scripts/RichEditor/emotions/default/41.gif',
                '/Scripts/RichEditor/emotions/default/42.gif',
                '/Scripts/RichEditor/emotions/default/43.gif',
                '/Scripts/RichEditor/emotions/default/44.gif',
                '/Scripts/RichEditor/emotions/default/45.gif',
                '/Scripts/RichEditor/emotions/default/46.gif',
                '/Scripts/RichEditor/emotions/default/47.gif',
                '/Scripts/RichEditor/emotions/default/48.gif',
                '/Scripts/RichEditor/emotions/default/49.gif',
                '/Scripts/RichEditor/emotions/default/50.gif'
            ]
        },
        'jinxing': {
            title: '金星',
            size: 50,
            imgs: [
                '/Scripts/RichEditor/emotions/jinxing/1.gif',
                '/Scripts/RichEditor/emotions/jinxing/2.gif',
                '/Scripts/RichEditor/emotions/jinxing/3.gif',
                '/Scripts/RichEditor/emotions/jinxing/4.gif',
                '/Scripts/RichEditor/emotions/jinxing/5.gif',
                '/Scripts/RichEditor/emotions/jinxing/6.gif'
            ]
        }
    };
    ...
    // 上传图片的配置
    // server地址
    E.config.uploadImgUrl = mercurius.BaseUrl+'/Upload/Index';
    // 超时时间
    ...
    E.createMenu(function (check) {
        ...
        $.each(configEmotions, function (k, val) {
            ...
            $.each(imgs, function (k, src) {
                var $command = $('<a href="#" commandValue="' + mercurius.BaseUrl + src + '"></a>');
                var $img = $('<img>');
                $img.css({
                    width: size + 'px',
                    height: size + 'px'
                });
                $img.attr('_src', mercurius.BaseUrl + src);  // 先将 src 复制到 '_src' 属性，先不加载
...
_e(function (E, $) {
    ...
    function loadHljs() {
        ...
        var script = document.createElement("script");
        script.type = "text/javascript";
        script.src = mercurius.BaseUrl + "/Scripts/RichEditor/highlight.pack.js";
        document.body.appendChild(script);
    }
