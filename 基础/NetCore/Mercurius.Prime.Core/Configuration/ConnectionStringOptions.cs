...
namespace Mercurius.Prime.Core.Configuration
{
    ...
    public class ConnectionStringOptions
    {
        ...
        private readonly Dictionary<string, ConnectionStringOptions> children;
        ...
        /// 主数据库连接信息
        /// </summary>
        public ConnectionStringOption Master { get; set; }
        ...
        /// <returns></returns>
        public ConnectionStringOptions this[string key]
        {
            get
            {
                return this.children.ContainsKey(key) ? this.children[key] : null;
            }
            set
            {
        ...
        {
            this.children = new Dictionary<string, ConnectionStringOptions>();
        }
